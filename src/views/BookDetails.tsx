            ...
            <div className="animate-fade-in max-w-7xl mx-auto p-4">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    <div className="w-full lg:w-1/3 flex-shrink-0">
                        <div
                            className="border-3 border-black dark:border-white p-4 bg-white dark:bg-gray-900 shadow-brutal dark:shadow-[4px_4px_0px_0px_#ffffff] relative">
                            <div
                                className="absolute -top-3 -right-3 bg-neon text-black font-mono text-xs font-bold px-2 py-1 border-2 border-black transform rotate-3">
                                EVIDENCE #{id}
                            </div>
                        ...
                        <div className="mt-6 font-mono text-sm space-y-2 text-gray-600 dark:text-gray-400">
                            <div className="flex justify-between border-b border-gray-300 dark:border-gray-700 py-1">
                                ...
                                <span
                                    className="font-bold text-black dark:text-white">{book.first_publish_date || 'N/A'}</span>
                            </div>
                            {book.subjects && (
                                <div className="py-2">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {book.subjects.slice(0, 5).map(sub => (
                                            <span key={sub}
                                                  className="bg-gray-100 dark:bg-gray-800 px-2 py-0.5 text-xs border border-gray-300 dark:border-gray-600">
                                            {sub}
                                        </span>
                                        ))}
                                    </div>
                    ...
                    <div className="flex-1">
                        ...
                        <div
                            className="bg-gray-50 dark:bg-gray-900 border-3 border-black dark:border-neon p-6 relative">
                            <div
                                className="absolute -top-3 left-4 bg-black text-white dark:bg-neon dark:text-black px-3 py-1 font-mono text-xs font-bold uppercase flex items-center gap-2">
                                <Database className="w-3 h-3"/>
                                Library Summary
                            </div>

                            <div
                                className="mt-2 font-mono leading-relaxed text-sm md:text-base text-justify dark:text-gray-300">
